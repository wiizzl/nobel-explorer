...
const AnimatedGroup = ({ children, className, variants, preset, as = "div", asChild = "div" }: AnimatedGroupProps) => {
  ...
  const MotionChild = useMemo(() => motion.create(asChild as keyof JSX.IntrinsicElements), [asChild]);
